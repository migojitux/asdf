...
# The question is an obvious case for Dijkstra's algorithm, so I searched for ruby implementations of it
# Thank you to https://gist.github.com/roganartu/9407316
# I have made some modifications to suit my usage, but am not presenting this as my own work!
...
if __FILE__ == $0 
  ...
  puts "## graph:"
  p graph
  puts "## graph.length_between(2,1):"
  p graph.length_between(2, 1)
  puts "## graph.neighbours(1):"
  p graph.neighbors(1)
  puts "## graph.dijkstra(1):"
